...
public:
  ...
  static Vec3 cross(Vec3 const &a, Vec3 const &b) {
    ...
    Vec3 res = Vec3(a[1] * b[2] - a[2] * b[1], a[2] * b[0] - a[0] * b[2],
                    a[0] * b[1] - a[1] * b[0]);
    return res;
  }
...
public:
  ...
  Mat3(float v1, float v2, float v3, float v4, float v5, float v6, float v7,
       float v8, float v9) {
    vals[0] = v1;
    vals[1] = v2;
    vals[2] = v3;
  ...
  Vec3 operator*(const Vec3 &p) {
    // TODO: Fonction à completer pour faire un produit matriciel entre 3x3 et
    // 1x3 Pour acceder à un element de la matrice (*this)(i,j) et du point p[i]
    Vec3 res((*this)(0, 0) * p[0] + (*this)(0, 1) * p[0] + (*this)(0, 2) * p[0],
             (*this)(1, 0) * p[1] + (*this)(1, 1) * p[1] + (*this)(1, 2) * p[1],
             (*this)(2, 0) * p[2] + (*this)(2, 1) * p[2] + (*this)(2, 2) * p[2]);
    return res;
  }

  Mat3 operator*(const Mat3 &m2) { // calcul du produit matriciel m1.m2
    // TODO: Fonction à completer
    // Pour acceder a un element de la premiere matrice (*this)(i,j) et de la
    // deuxième m2(k,l)
    Mat3 res = Mat3((*this)(0, 0) * m2(0, 0) + (*this)(0, 1) * m2(1, 0) +
                        (*this)(0, 2) * m2(2, 0),
                    (*this)(0, 0) * m2(0, 1) + (*this)(0, 1) * m2(1, 1) +
                        (*this)(0, 2) * m2(1, 2),
                    (*this)(0, 0) * m2(0, 2) + (*this)(0, 1) * m2(1, 2) +
                        (*this)(0, 2) * m2(2, 2),
                    (*this)(1, 0) * m2(0, 0) + (*this)(1, 1) * m2(1, 0) +
                        (*this)(1, 2) * m2(2, 0),
                    (*this)(1, 0) * m2(0, 1) + (*this)(1, 1) * m2(1, 1) +
                        (*this)(1, 2) * m2(2, 1),
                    (*this)(1, 0) * m2(0, 2) + (*this)(1, 1) * m2(1, 2) +
                        (*this)(1, 2) * m2(2, 2),
                    (*this)(2, 0) * m2(0, 0) + (*this)(2, 1) * m2(1, 0) +
                        (*this)(2, 2) * m2(2, 0),
                    (*this)(2, 0) * m2(0, 1) + (*this)(2, 1) * m2(1, 1) +
                        (*this)(2, 2) * m2(2, 1),
                    (*this)(2, 0) * m2(0, 2) + (*this)(2, 1) * m2(1, 2) +
                        (*this)(2, 2) * m2(2, 2));
    return res;
  }
  ...
  Mat3 operator-(const Mat3 &m2) {
    return Mat3((*this)(0, 0) - m2(0, 0), (*this)(0, 1) - m2(0, 1),
                (*this)(0, 2) - m2(0, 2), (*this)(1, 0) - m2(1, 0),
                (*this)(1, 1) - m2(1, 1), (*this)(1, 2) - m2(1, 2),
                (*this)(2, 0) - m2(2, 0), (*this)(2, 1) - m2(2, 1),
                (*this)(2, 2) - m2(2, 2));
  }
  ...
  Mat3 operator/(float s) {
    return Mat3((*this)(0, 0) / s, (*this)(0, 1) / s, (*this)(0, 2) / s,
  ...
  Mat3 operator-() const {
    return Mat3(-vals[0], -vals[1], -vals[2], -vals[3], -vals[4], -vals[5],
...
inline static Mat3 operator*(float s, const Mat3 &m) {
  return Mat3(m(0, 0) * s, m(0, 1) * s, m(0, 2) * s, m(1, 0) * s, m(1, 1) * s,
