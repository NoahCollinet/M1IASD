...
public class ZebreExtension {
	...
	public static void main(String[] args) {
		...
		IntVar nor = model.intVar("Norwegian", 1);         
        ...
        // Contraintes
        int [][] Right = new int[][] {{1,2},{2,3},{3,4},{4,5}};
        Tuples tuplesRight = new Tuples(Right,true);
        ...
        // C6
        model.table(new IntVar[]{ivo,gre}, tuplesRight).post();
