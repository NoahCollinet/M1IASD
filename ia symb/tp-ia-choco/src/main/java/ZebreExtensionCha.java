...
public class ZebreExtensionCha {
	...
	public static void main(String[] args) {
		...
		IntVar mil = model.intVar("Milk", new int []{3});
        ...
        // Contraintes
        int [][] justRight = new int[][] {{1,2},{2,3},{3,4},{4,5}};
        Tuples tuplesJustRight = new Tuples(justRight,true);
        
        int [][] nextTo = new int[][] {{1,2},{2,1},{2,3},{3,2},{3,4},{4,3},{4,5},{5,4}};
        Tuples tuplesNextTo = new Tuples(nextTo,true);
        ...
        // 6
        model.table(new IntVar[]{ivo,gre}, tuplesJustRight).post();
        ...
        // 11
        model.table(new IntVar[]{che,fox}, tuplesNextTo).post();
        
        // 12
        model.table(new IntVar[]{koo,hor}, tuplesNextTo).post();
        ...
        // 15
        model.table(new IntVar[]{nor,blu}, tuplesNextTo).post();
